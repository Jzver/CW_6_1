...
from mailings.models import Client, Log, Message, Newsletter
...
class NewsletterUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse("mailings:newsletter_detail", args=[self.get_object().pk])
...
class MessageUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse("mailings:message_detail", args=[self.get_object().pk])
...
class ClientUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        """Метод для определения пути, куда будет совершен переход после редактирования сообщения"""
        return reverse("mailings:client_detail", args=[self.get_object().pk])
